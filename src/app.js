...
const INVENTORY_SCHEMA_VERSION = 'building-details-v3';
...
function loadState(){
  ...
  return { units: (window.MYAPT_INVENTORY_SEED || []).map(normalizeUnit), updated_at: null, source: 'sample', inventory_schema_version: INVENTORY_SCHEMA_VERSION };
}
